...
public class HciEndpoint private constructor(
    @PublishedApi
    ...
    public companion object {
        public operator fun invoke(config: HciConfig): HciEndpoint {
            ...
            return HciEndpoint(httpClient, config.baseUrl + "mgate.exe", baseRequest)
        }

        public operator fun invoke(init: HciConfig.() -> Unit): HciEndpoint = HciConfig(init).let(::invoke)
    }
}