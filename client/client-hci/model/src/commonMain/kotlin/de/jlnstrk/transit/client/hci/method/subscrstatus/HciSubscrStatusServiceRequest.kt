...
@HciModel("1.45")
@Serializable
public data class HciSubscrStatusServiceRequest(
  ...
  public companion object {
    public inline operator fun invoke(`init`: HciSubscrStatusServiceRequest.() -> Unit):
        HciSubscrStatusServiceRequest =
        de.jlnstrk.transit.client.hci.method.subscrstatus.HciSubscrStatusServiceRequest().apply(init)
  }
}
