package de.jlnstrk.transit.client.hci.method.subscrusercreate
...
@HciModel("1.45")
@Serializable
public data class HciSubscrUserCreateServiceRequest(
  ...
  public companion object {
    public inline operator fun invoke(`init`: HciSubscrUserCreateServiceRequest.() -> Unit):
        HciSubscrUserCreateServiceRequest =
        de.jlnstrk.transit.client.hci.method.subscrusercreate.HciSubscrUserCreateServiceRequest().apply(init)
  }
}
